...
{
    public class NativeListJobProjectileStorageBenchmark : IProjectileStorageBenchmark
    {
        ...
        public string StructureName => "NativeListJob";
        ...
        private int RunAddElementsJob(BenchmarkConfigData config)
        {
            ...
            _items = new NativeList<ProjectileData>(operationCount, Allocator.Persistent);
        ...
        private void PrepareItems()
        {
            ...
            _items = new NativeList<ProjectileData>(length, Allocator.Persistent);
            _isItemsCreated = true;
        ...
        [BurstCompile]
        private struct FillNativeListJob : IJob
        {
            [ReadOnly] public NativeArray<ProjectileData> Source;
            public NativeList<ProjectileData> Items;
            public int Count;
